// use ajax calls and built in promise to make an http request. the request constant is looking for the 
// json data location. runs success or error functions based on the results of the request. returns results
// for each phone returned with an id
